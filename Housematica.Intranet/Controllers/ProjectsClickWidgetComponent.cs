...
{
    public class ProjectsClickWidgetComponent : ViewComponent
    {
        private readonly HousematicaContext _context;
        public ProjectsClickWidgetComponent(HousematicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(Guid License)
        {
            ...
            return View("ProjectsClickWidgetComponent");
        }
