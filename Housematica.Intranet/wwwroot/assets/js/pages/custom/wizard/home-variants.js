	    ...
	    <div id="variant" style="margin-top: 2em">
		    ...
		    <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" name="HouseVariants[` + (numberOfVariant) + `].HouseArea" asp-for="HouseVariants[` + (numberOfVariant) + `].HouseArea"  id="apartmentArea` + (numberOfVariant + 1) + `" placeholder="Apartment area" value=""  />
            ...
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" name="HouseVariants[` + (numberOfVariant) + `].BalconyArea" asp-for="HouseVariants[` + (numberOfVariant) + `].BalconyArea" id="balconyArea` + (numberOfVariant + 1) + `" placeholder="Balcon/garden area" value="" />
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    onwheel="return false;" class="form-control form-control-solid form-control-lg" name="HouseVariants[` + (numberOfVariant) + `].NumberOfLivingRoom" asp-for="HouseVariants[` + (numberOfVariant) + `].NumberOfLivingRoom" id="numberLivingRoom` + (numberOfVariant + 1) + `" id="roomNumber" placeholder="Number living room" value="" />
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" name="HouseVariants[` + (numberOfVariant) + `].HousePrice" asp-for="HouseVariants[` + (numberOfVariant) + `].HousePrice" id="apartmentPrice` + (numberOfVariant + 1) + `" id="roomNumber" placeholder="Apartment price" value="" />
...
<input type="text" name="HouseVariants[` + (numberOfVariant) + `].HouseModel" class="ApartmentVariant` + (numberOfVariant + 1) + `" id="apartmentModelName` + (numberOfVariant + 1) + `"/>
            </div>
    </div>`;
...
function addRooms(element) {
    ...
    for (var i = 0; i < number; i++) {
     ...
     <div class="form-group">
         ...
         <input type="text" class="form-control form-control-solid form-control-lg" id="`+ element + `roomName` + (i + 1) + `" asp-for="HouseVariants[` + (element-1) + `].HouseRooms[` + (i) + `].RoomName" name="HouseVariants[` + (element-1) + `].HouseRooms[` + (i) + `].RoomName" placeholder="Room name"  value="" />
 ...
 <div class="col-xl-6">
     ...
     <div class="form-group">
         ...
         <input type="text" class="form-control form-control-solid form-control-lg" id="`+ element + `roomArea` + (i + 1) + `" asp-for="HouseVariants[` + (element - 1) + `].HouseRooms[` + (i) + `].RoomArea" name="HouseVariants[` + (element - 1) + `].HouseRooms[` + (i) + `].RoomArea" placeholder="Room area"  value="" />
