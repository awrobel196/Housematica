        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input min="0" type="number" class="form-control form-control-solid form-control-lg"  id="numberRooms`+ (numberOfVariant + 1) + `,` + (numberOfVariant + 1) + ` " placeholder="Number rooms"  onwheel="return false;" onkeyup="addRooms(this.id)" onclick="addRooms(this.id)" oninput="sendToFinalStep(this)"/>
