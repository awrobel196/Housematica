...
function addKitchenVariant() {
    ...
    for (i = 2; i <= numberKitchenVariant; i++) {
        ...
        console.log(thiskitchenDescription);
	...
	<div class="col-xl-6" id="kitchenConfigure" data-list="listElement">
		
                                    <div class="form-group">
										
                                        <label>Option name</label>
                                    <input type="text" value="Kitchen" name="ApartmentOption[` + (listElementCount) + `].OptionType" asp-for="ApartmentOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="kitchenName`+ (numberKitchenVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].OptionName" asp-for="ApartmentOption[` + (listElementCount) + `].OptionName"  oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="kitchenPrice`+ (numberKitchenVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].Price" asp-for="ApartmentOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
										...
										<textarea class="form-control form-control-solid form-control-lg" id="kitchenDescription`+ (numberKitchenVariant + 1) + `" rows="4" name="ApartmentOption[` + (listElementCount) + `].OptionDescription" asp-for="ApartmentOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
								...
								<div class="col-xl-12">
									<div class="form-group">
										...
										<div class="custom-file">
											...
											<input type="file" class="custom-file-input" id="KitchenOption`+ (numberKitchenVariant + 1) + `" multiple
...
function addBathroomVariant() {
	...
	<div class="col-xl-6" id="bathroomConfigure" data-list="listElement">
		
                                    <div class="form-group">
										
                                        <label>Option name</label>
 <input type="text" value="Bathroom" name="ApartmentOption[` + (listElementCount) + `].OptionType" asp-for="ApartmentOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="bathroomName`+ (numberBathroomVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].OptionName" asp-for="ApartmentOption[` + (listElementCount) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="bathroomPrice`+ (numberBathroomVariant + 1) + `"  name="ApartmentOption[` + (listElementCount) + `].Price" asp-for="ApartmentOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="bathroomDescription`+ (numberBathroomVariant + 1) + `" rows="4" name="ApartmentOption[` + (listElementCount) + `].OptionDescription" asp-for="ApartmentOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
								...
								<div class="col-xl-12">
									<div class="form-group">
										...
										<div class="custom-file">
											...
											<input type="file" class="custom-file-input"  id="BathroomOption`+ (numberBathroomVariant + 1) + `" multiple
                                                               onchange="readURL(this)"/>
											<label class="custom-file-label" for="customFile">Choose file</label>
											<span class="form-text text-muted" >Please upload option visualisation.</span>
										</div>
...
function addRoomsVariant() {
	...
	<div class="col-xl-6" id="roomsConfigure" data-list="listElement">
		
                                    <div class="form-group">
										
                                        <label>Option name</label>
 <input type="text" value="Rooms" name="ApartmentOption[` + (listElementCount) + `].OptionType" asp-for="ApartmentOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roomsName`+ (numberRoomsVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].OptionName" asp-for="ApartmentOption[` + (listElementCount) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roomsPrice`+ (numberRoomsVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].Price"  asp-for="ApartmentOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg"  id="roomsDescription`+ (numberRoomsVariant + 1) + `" rows="4" name="ApartmentOption[` + (listElementCount) + `].OptionDescription" asp-for="ApartmentOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
								...
								<div class="col-xl-12">
									<div class="form-group">
										...
										<div class="custom-file">
											...
											<input type="file" class="custom-file-input" id="RoomsOption`+ (numberRoomsVariant + 1) + `" multiple
                                                               onchange="readURL(this)"/>
											<label class="custom-file-label" for="customFile">Choose file</label>
											<span class="form-text text-muted" >Please upload option visualisation.</span>
										</div>
...
function addDoorWindowVariant() {
	...
	<div class="col-xl-6" id="doorWindowConfigure" data-list="listElement">
		
                                    <div class="form-group">
										
                                        <label>Option name</label>
 <input type="text" value="Door and window" name="ApartmentOption[` + (listElementCount) + `].OptionType" asp-for="ApartmentOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="doorWindowName`+ (numberDoorWindowVariant + 1) + `"  name="ApartmentOption[` + (listElementCount) + `].OptionName"  asp-for="ApartmentOption[` + (listElementCount) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="doorWindowPrice`+ (numberDoorWindowVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].Price" asp-for="ApartmentOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg"  rows="4"  id="doorWindowDescription`+ (numberDoorWindowVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].OptionDescription"  asp-for="ApartmentOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
								...
								<div class="col-xl-12">
									<div class="form-group">
										...
										<div class="custom-file">
											...
											<input type="file" class="custom-file-input" id="DoorWindowVariant`+ (numberDoorWindowVariant + 1) + `" multiple
                                                               onchange="readURL(this)"/>
											<label class="custom-file-label" for="customFile">Choose file</label>
											<span class="form-text text-muted" >Please upload option visualisation.</span>
										</div>
...
//This code add new roof variant
//Begin code
function addRoofVariant() {

    var listElementCount = $("div[data-list=listElement]").length;
    console.log(listElementCount);
    //Check how many variant exist in this moment
    var numberRoofVariant = document.querySelectorAll('#roofConfigure').length;

    if (numberRoofVariant != 0) {

        document.getElementById("numberOfRoofOption").innerHTML = numberRoofVariant + 1;
    }

    var roofNameArray = new Array();
    var roofPriceArray = new Array();
    var roofDescriptionArray = new Array();

    for (i = 2; i <= numberRoofVariant; i++) {

        //Create array where we save temp input value (we must save it, since they are reset when we add new variant)
        var thisroofName = "roofName" + i;
        var thisroofPrice = "roofPrice" + i;
        var thisroofDescription = "roofDescription" + i;


        roofNameArray[i] = document.getElementById(thisroofName).value;
        roofPriceArray[i] = document.getElementById(thisroofPrice).value;
        console.log(thisroofDescription);
        roofDescriptionArray[i] = document.getElementById(thisroofDescription).value;

    }


    //Add new variant
    document.getElementById('placeToRoofVariant').innerHTML += `
    <div class="col-xl-12" style="margin-bottom:2em"><div class="separator separator-solid"></div>
    <h3 class="text-dark-25" style="margin-top:2rem !important; margin-bottom:-1rem !important">`+ (numberRoofVariant + 1) + `. Additional roof variant</h3></div>
	
	<div class="col-xl-6" id="roofConfigure" data-list="listElement">
		
                                    <div class="form-group">
										
                                        <label>Option name</label>
                                    <input type="text" value="Roof" name="ApartmentOption[` + (listElementCount) + `].OptionType" asp-for="ApartmentOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roofName`+ (numberRoofVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].OptionName" asp-for="ApartmentOption[` + (listElementCount) + `].OptionName"  oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                        <span class="form-text text-muted">Please enter roof option name.</span>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roofPrice`+ (numberRoofVariant + 1) + `" name="ApartmentOption[` + (listElementCount) + `].Price" asp-for="ApartmentOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
                                        <span class="form-text text-muted">Please enter roof option price.</span>
                                    </div>
								</div>
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="roofDescription`+ (numberRoofVariant + 1) + `" rows="4" name="ApartmentOption[` + (listElementCount) + `].OptionDescription" asp-for="ApartmentOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
										 <span class="form-text text-muted">Please enter option description.</span>
                                    </div>
								</div>
								<div class="col-xl-12">
									<div class="form-group">
										...
										<div class="custom-file">
											...
											<input type="file" class="custom-file-input" id="RoofOption`+ (numberRoofVariant + 1) + `" multiple
                                                               onchange="readURL(this)"/>
											<label class="custom-file-label" for="customFile">Choose file</label>
											<span class="form-text text-muted" >Please upload option visualisation.</span>
										</div>
    ...
    for (i = 2; i <= numberRoofVariant; i++) {
        ...
        document.getElementById(thisroofName).value = roofNameArray[i];
        document.getElementById(thisroofPrice).value = roofPriceArray[i];
        document.getElementById(thisroofDescription).value = roofDescriptionArray[i];

    }


    //This code add roof otion details to final step. This code check how many option we have and add only iine new variant (don't reset earlier row)
    for (i = numberRoofVariant; i <= numberRoofVariant; i++) {
        document.getElementById('roofOptionRest').innerHTML += `

    <div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle" id="headingTwo`+ (i + 11) + `" id="customRoofOption">
    <div class="card">
        <div class="card-header" id="headingTwo`+ (i + 11) + `" id="customRoofOption">
            <div class="card-title collapsed" data-toggle="collapse" data-target="#configureCollapseRoof`+ (i + 11) + `" style="padding: 0px;">
                <span class="svg-icon svg-icon-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <polygon points="0 0 24 0 24 24 0 24"></polygon>
                ...
                font-family: Poppins, Helvetica, 'sans-serif';
                color: #3F4254 !important;
                padding-left: 0.2rem !important;"><b>`+ (i + 1) + `. Roof variant</b></div>
            </div>
        </div>
        <div id="configureCollapseRoof`+ (i + 11) + `" style="padding-left: 1.8rem !important;" class="collapse text-dark-50" data-parent="#headingTwo` + (i + 11) + `">
            <div>Option name: <span id="roofName`+ (i + 1) + `Final"></span></div>
            <div>Option price: <span id="roofPrice`+ (i + 1) + `Final"></span></div>
            <div>Option description: <span id="roofDescription`+ (i + 1) + `Final"></span></div>
        </div>
    </div>
</div>`}
}
...
//This function add first roof option details in final step
//Start function
function addRoofFirstOptionInFinalStep() {
    document.getElementById("roofOptionFirst").innerHTML += `

    <div id="placeToRoofVariantFinal">
   
        <div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle" id="accordionExample8" id="customRoofOption">
        
        
        <div class="card">
            <div class="card-header" id="headingTwo7" id="customRoofOption">
                <div class="card-title collapsed" data-toggle="collapse" data-target="#configureCollapseRoof" style="padding: 0px;">
                    <span class="svg-icon svg-icon-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <polygon points="0 0 24 0 24 24 0 24"></polygon>
                    ...
                    font-family: Poppins, Helvetica, 'sans-serif';
                    color: #3F4254 !important;
                    padding-left: 0.2rem !important;"><b>1. Roof variant</b></div>
                </div>
            </div>
            <div id="configureCollapseRoof" style="padding-left: 1.8rem !important;" class="collapse text-dark-50" data-parent="#accordionExample8" >
                <div>Option name: <span id="roofName1Final"></span></div>
                <div>Option price: <span id="roofPrice1Final"></span></div>
                <div>Option description: <span id="roofDescription1Final"></span></div>
...
//This function add first configure roof option
//Begin function
function showRoofOptions() {

    if ($("#roofCheckbox").is(':checked')) {
        $("#roofConfigure").removeClass("display-none");
        $("#roofOptionRest").removeClass("display-none");
        $("#roofOptionFirst").removeClass("display-none");
        //This function add first roof option details in final step

        //This function check in final step exist first option, if not create then
        if ($('#roofOptionFirst').children().length < 1) {
            addRoofFirstOptionInFinalStep();
        }




        //This function check how many roof option exist (when set checkbox checked) and send it to final step
        var numberRoofVariant = document.querySelectorAll('#roofConfigure').length;

        if (numberRoofVariant != 0) {
            document.getElementById("numberOfRoofOption").innerHTML = numberRoofVariant;
        }
    }

    else {
        //This function check how many roof option exist (when set checkbox checked) and dend it to final step
        $("#roofConfigure").addClass("display-none");
        $("#roofOptionRest").addClass("display-none");
        $("#roofOptionFirst").addClass("display-none");
        document.getElementById("numberOfRoofOption").innerHTML = "none option";
