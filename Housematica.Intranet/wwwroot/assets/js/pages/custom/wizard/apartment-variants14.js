...
function addApartmentVariant() {
    ...
    if (numberOfVariant > 1) {
        for (i = 2; i <= numberOfVariant; i++) {
            ...
            apartmentModelName[i] = document.getElementById(thisApartmentModelName).value;
	    ...
	    <div id="variant" style="margin-top: 2em">
		    ...
		    <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" name="ApartmentVariants[` + (numberOfVariant) + `].ApartmentArea" asp-for="ApartmentVariants[` + (numberOfVariant) + `].ApartmentArea"  id="apartmentArea` + (numberOfVariant + 1) + `" placeholder="Apartment area" value=""  />
            ...
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" name="ApartmentVariants[` + (numberOfVariant) + `].BalconyArea" asp-for="ApartmentVariants[` + (numberOfVariant) + `].BalconyArea" id="balconyArea` + (numberOfVariant + 1) + `" placeholder="Balcon/garden area" value="" />
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    onwheel="return false;" class="form-control form-control-solid form-control-lg" name="ApartmentVariants[` + (numberOfVariant) + `].NumberOfLivingRoom" asp-for="ApartmentVariants[` + (numberOfVariant) + `].NumberOfLivingRoom" id="numberLivingRoom` + (numberOfVariant + 1) + `" id="roomNumber" placeholder="Number living room" value="" />
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" name="ApartmentVariants[` + (numberOfVariant) + `].ApartmentPrice" asp-for="ApartmentVariants[` + (numberOfVariant) + `].ApartmentPrice" id="apartmentPrice` + (numberOfVariant + 1) + `" id="roomNumber" placeholder="Apartment price" value="" />
...
<input type="text" name="ApartmentVariants[` + (numberOfVariant) + `].ApartmentModel" class="ApartmentVariant` + (numberOfVariant + 1) + `" id="apartmentModelName` + (numberOfVariant + 1) + `"/>
            </div>
    </div>`;
...
function addRooms(element) {
    ...
    for (var i = 0; i < number; i++) {
     ...
     <div class="form-group">
         ...
         <input type="text" class="form-control form-control-solid form-control-lg" id="`+ element + `roomName` + (i + 1) + `" asp-for="ApartmentVariants[` + (element-1) + `].Rooms[` + (i) + `].RoomName" name="ApartmentVariants[` + (element-1) + `].Rooms[` + (i) + `].RoomName" placeholder="Room name"  value="" />
 ...
 <div class="col-xl-6">
     ...
     <div class="form-group">
         ...
         <input type="text" class="form-control form-control-solid form-control-lg" id="`+ element + `roomArea` + (i + 1) + `" asp-for="ApartmentVariants[` + (element-1) + `].Rooms[` + (i) + `].RoomArea" name="ApartmentVariants[` + (element-1) + `].Rooms[` + (i) + `].RoomArea" placeholder="Room area"  value="" />
