...
function addBathroomVariant() {
 ...
 <input type="text" value="Bathroom" name="HouseOption[` + (listElementCount) + `].OptionType" asp-for="HouseOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="bathroomName`+ (numberBathroomVariant + 1) + `" name="HouseOption[` + (listElementCount) + `].OptionName" asp-for="HouseOption[` + (listElementCount) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="bathroomPrice`+ (numberBathroomVariant + 1) + `"  name="HouseOption[` + (listElementCount) + `].Price" asp-for="HouseOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
										...
										<textarea class="form-control form-control-solid form-control-lg" id="bathroomDescription`+ (numberBathroomVariant + 1) + `" rows="4" name="HouseOption[` + (listElementCount) + `].OptionDescription" asp-for="HouseOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
...
function addRoomsVariant() {
	...
	<div class="col-xl-6" id="roomsConfigure" data-list="listElement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
 <input type="text" value="Rooms" name="HouseOption[` + (listElementCount) + `].OptionType" asp-for="HouseOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roomsName`+ (numberRoomsVariant + 1) + `" name="HouseOption[` + (listElementCount) + `].OptionName" asp-for="HouseOption[` + (listElementCount) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roomsPrice`+ (numberRoomsVariant + 1) + `" name="HouseOption[` + (listElementCount) + `].Price"  asp-for="HouseOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg"  id="roomsDescription`+ (numberRoomsVariant + 1) + `" rows="4" name="HouseOption[` + (listElementCount) + `].OptionDescription" asp-for="HouseOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
...
function addDoorWindowVariant() {
	...
	<div class="col-xl-6" id="doorWindowConfigure" data-list="listElement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
 <input type="text" value="Door and window" name="HouseOption[` + (listElementCount) + `].OptionType" asp-for="HouseOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="doorWindowName`+ (numberDoorWindowVariant + 1) + `"  name="HouseOption[` + (listElementCount) + `].OptionName"  asp-for="HouseOption[` + (listElementCount) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="doorWindowPrice`+ (numberDoorWindowVariant + 1) + `" name="HouseOption[` + (listElementCount) + `].Price" asp-for="HouseOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg"  rows="4"  id="doorWindowDescription`+ (numberDoorWindowVariant + 1) + `" name="HouseOption[` + (listElementCount) + `].OptionDescription"  asp-for="HouseOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
...
function addRoofVariant() {
	...
	<div class="col-xl-6" id="roofConfigure" data-list="listElement">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
                                    <input type="text" value="Roof" name="HouseOption[` + (listElementCount) + `].OptionType" asp-for="HouseOption[` + (listElementCount) + `].OptionType"  style="display:none" />
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roofName`+ (numberRoofVariant + 1) + `" name="HouseOption[` + (listElementCount) + `].OptionName" asp-for="HouseOption[` + (listElementCount) + `].OptionName"  oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roofPrice`+ (numberRoofVariant + 1) + `" name="HouseOption[` + (listElementCount) + `].Price" asp-for="HouseOption[` + (listElementCount) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="roofDescription`+ (numberRoofVariant + 1) + `" rows="4" name="HouseOption[` + (listElementCount) + `].OptionDescription" asp-for="HouseOption[` + (listElementCount) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
