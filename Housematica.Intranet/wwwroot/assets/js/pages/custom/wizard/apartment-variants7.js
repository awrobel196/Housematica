...
function addRooms(element) {
    ...
    for (var i = 0; i < number; i++) {
     ...
     <div class="form-group">
         ...
         <input type="text" class="form-control form-control-solid form-control-lg" id="`+ element + `roomName` + (i + 1) + `" asp-for="ApartmentVariants[` + element + `].Rooms[` + (i + 1) + `].RoomName" name="ApartmentVariants[` + element + `].Rooms[` + (i + 1) + `].RoomName" placeholder="Room name"  value="" />
 ...
 <div class="col-xl-6">
     ...
     <div class="form-group">
         ...
         <input type="text" class="form-control form-control-solid form-control-lg" id="`+ element + `roomArea` + (i + 1) + `" asp-for="ApartmentVariants[` + element + `].Rooms[` + (i + 1) + `].RoomArea" name="ApartmentVariants[` + element + `].Rooms[` + (i + 1) + `].RoomArea" placeholder="Room area"  value="" />
