	...
	<div class="col-xl-6" id="kitchenConfigure" data-list="listElement">
								...
								<div class="col-xl-12">
                                    <div class="form-group">
										...
										<textarea class="form-control form-control-solid form-control-lg" id="kitchenDescription`+ (numberKitchenVariant + 1) + `" rows="4" name="ApartmentOption[` + (numberKitchenVariant) + `].OptionDescription" asp-for="ApartmentOption[` + (numberKitchenVariant) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
...
function addBathroomVariant() {
	...
	<div class="col-xl-6" id="bathroomConfigure" data-list="listElement">
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="bathroomDescription`+ (numberBathroomVariant + 1) + `" rows="4" name="ApartmentOption[10` + (numberBathroomVariant) + `].OptionDescription" asp-for="ApartmentOption[10` + (numberBathroomVariant) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
	...
	<div class="col-xl-6" id="roomsConfigure" data-list="listElement">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roomsPrice`+ (numberRoomsVariant + 1) + `" name="ApartmentOption[20` + (numberRoomsVariant) + `].Price"  asp-for="ApartmentOption[20` + (numberRoomsVariant) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg"  id="roomsDescription`+ (numberRoomsVariant + 1) + `" rows="4" name="ApartmentOption[20` + (numberRoomsVariant) + `].OptionDescription" asp-for="ApartmentOption[20` + (numberRoomsVariant) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
...
function addDoorWindowVariant() {
	...
	<div class="col-xl-6" id="doorWindowConfigure" data-list="listElement">
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg"  rows="4"  id="doorWindowDescription`+ (numberDoorWindowVariant + 1) + `" name="ApartmentOption[30` + (numberDoorWindowVariant) + `].OptionDescription"  asp-for="ApartmentOption[30` + (numberDoorWindowVariant) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
