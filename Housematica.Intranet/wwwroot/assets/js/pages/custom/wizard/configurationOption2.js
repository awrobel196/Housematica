...
function addKitchenVariant() {
	...
	<div class="col-xl-6" id="kitchenConfigure">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="kitchenName`+ (numberKitchenVariant + 1) + `" asp-for="ApartmentOption[` + (numberKitchenVariant + 1) + `].OptionName"  oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="kitchenPrice`+ (numberKitchenVariant + 1) + `" asp-for="ApartmentOption[` + (numberKitchenVariant + 1) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
										...
										<textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" id="kitchenDescription`+ (numberKitchenVariant + 1) + `" rows="4" asp-for="ApartmentOption[` + (numberKitchenVariant + 1) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
...
function addBathroomVariant() {
	...
	<div class="col-xl-6" id="bathroomConfigure">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="bathroomName`+ (numberBathroomVariant + 1) + `" asp-for="ApartmentOption[10` + (numberBathroomVariant + 1) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="bathroomPrice`+ (numberBathroomVariant + 1) + `" asp-for="ApartmentOption[10` + (numberBathroomVariant + 1) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" id="bathroomDescription`+ (numberBathroomVariant + 1) + `" rows="4" asp-for="ApartmentOption[10` + (numberBathroomVariant + 1) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
...
function addRoomsVariant() {
	...
	<div class="col-xl-6" id="roomsConfigure">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="roomsName`+ (numberRoomsVariant + 1) + `" asp-for="ApartmentOption[20` + (numberRoomsVariant + 1) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" namide="roomsPrice`+ (numberRoomsVariant + 1) + `"  asp-for="ApartmentOption[20` + (numberRoomsVariant + 1) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" id="roomsDescription`+ (numberRoomsVariant + 1) + `" rows="4"  asp-for="ApartmentOption[20` + (numberRoomsVariant + 1) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
...
function addDoorWindowVariant() {
	...
	<div class="col-xl-6" id="doorWindowConfigure">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="doorWindowName`+ (numberDoorWindowVariant + 1) + `"   asp-for="ApartmentOption[30` + (numberDoorWindowVariant + 1) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" id="doorWindowPrice`+ (numberDoorWindowVariant + 1) + `" asp-for="ApartmentOption[30` + (numberDoorWindowVariant + 1) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" rows="4"  id="doorWindowDescription`+ (numberDoorWindowVariant + 1) + `" asp-for="ApartmentOption[30` + (numberDoorWindowVariant + 1) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
