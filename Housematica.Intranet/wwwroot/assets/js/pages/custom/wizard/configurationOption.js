...
function addKitchenVariant() {
    ...
    for (i = 2; i <= numberKitchenVariant; i++) {
        ...
        kitchenNameArray[i] = document.getElementsByName(thiskitchenName)[0].value;
        kitchenPriceArray[i] = document.getElementsByName(thiskitchenPrice)[0].value;
        kitchenDescriptionArray[i] = document.getElementsByName(thiskitchenDescription)[0].value;
	...
	<div class="col-xl-6" id="kitchenConfigure">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="kitchenName`+ (numberKitchenVariant + 1) + `" asp-for="ApartmentOption[`+ (numberKitchenVariant + 1) + `].OptionName"  oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="kitchenPrice`+ (numberKitchenVariant + 1) + `" asp-for="ApartmentOption[`+ (numberKitchenVariant + 1) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
										...
										<textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" name="kitchenDescription`+ (numberKitchenVariant + 1) + `" rows="4" asp-for="ApartmentOption[`+ (numberKitchenVariant + 1) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
    ...
    for (i = 2; i <= numberKitchenVariant; i++) {
        ...
        document.getElementsByName(thiskitchenName)[0].value = kitchenNameArray[i];
        document.getElementsByName(thiskitchenPrice)[0].value = kitchenPriceArray[i];
        document.getElementsByName(thiskitchenDescription)[0].value = kitchenDescriptionArray[i];
...
function addBathroomVariant() {
    ...
    for (i = 2; i <= numberBathroomVariant; i++) {
        ...
        bathroomNameArray[i] = document.getElementsByName(thisBathroomName)[0].value;
        bathroomPriceArray[i] = document.getElementsByName(thisBathroomPrice)[0].value;
        bathroomDescriptionArray[i] = document.getElementsByName(thisBathroomDescription)[0].value;
	...
	<div class="col-xl-6" id="bathroomConfigure">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="bathroomName`+ (numberBathroomVariant + 1) + `" asp-for="ApartmentOption[10`+ (numberBathroomVariant + 1) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="bathroomPrice`+ (numberBathroomVariant + 1) + `" asp-for="ApartmentOption[10`+ (numberBathroomVariant + 1) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" name="bathroomDescription`+ (numberBathroomVariant + 1) + `" rows="4" asp-for="ApartmentOption[10`+ (numberBathroomVariant + 1) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
    ...
    for (i = 2; i <= numberBathroomVariant; i++) {
        ...
        document.getElementsByName(thisBathroomName)[0].value = bathroomNameArray[i];
        document.getElementsByName(thisBathroomPrice)[0].value = bathroomPriceArray[i];
        document.getElementsByName(thisBathroomDescription)[0].value = bathroomDescriptionArray[i];
...
function addRoomsVariant() {
    ...
    for (i = 2; i <= numberRoomsVariant; i++) {
        ...
        roomsNameArray[i] = document.getElementsByName(thisRoomsName)[0].value;
        roomsPriceArray[i] = document.getElementsByName(thisRoomsPrice)[0].value;
        roomsDescriptionArray[i] = document.getElementsByName(thisRoomsDescription)[0].value;
	...
	<div class="col-xl-6" id="roomsConfigure">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="roomsName`+ (numberRoomsVariant + 1) + `" asp-for="ApartmentOption[20`+ (numberRoomsVariant + 1) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="roomsPrice`+ (numberRoomsVariant + 1) + `"  asp-for="ApartmentOption[20`+ (numberRoomsVariant + 1) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" name="roomsDescription`+ (numberRoomsVariant + 1) + `" rows="4"  asp-for="ApartmentOption[20`+ (numberRoomsVariant + 1) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
    ...
    for (i = 2; i <= numberRoomsVariant; i++) {
        ...
        document.getElementsByName(thisRoomsName)[0].value = roomsNameArray[i];
        document.getElementsByName(thisRoomsPrice)[0].value = roomsPriceArray[i];
        document.getElementsByName(thisRoomsDescription)[0].value = roomsDescriptionArray[i];
...
function addDoorWindowVariant() {
    ...
    for (i = 2; i <= numberDoorWindowVariant; i++) {
        ...
        doorWindowNameArray[i] = document.getElementsByName(thisDoorWindowName)[0].value;
        doorWindowPriceArray[i] = document.getElementsByName(thisDoorWindowPrice)[0].value;
        doorWindowDescriptionArray[i] = document.getElementsByName(thisDoorWindowDescription)[0].value;
	...
	<div class="col-xl-6" id="doorWindowConfigure">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option name</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="doorWindowName`+ (numberDoorWindowVariant + 1) + `"   asp-for="ApartmentOption[30`+ (numberDoorWindowVariant + 1) + `].OptionName" oninput="sendToFinalStep(this)" placeholder="Option name" value="" />
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Option price</label>
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="doorWindowPrice`+ (numberDoorWindowVariant + 1) + `" asp-for="ApartmentOption[30`+ (numberDoorWindowVariant + 1) + `].Price" oninput="sendToFinalStep(this)"placeholder="Option price" value="" />
								...
								<div class="col-xl-12">
                                    <div class="form-group">
                                        <label>Option description</label>
										<textarea class="form-control form-control-solid form-control-lg" id="exampleTextarea" rows="4"  name="doorWindowDescription`+ (numberDoorWindowVariant + 1) + `" asp-for="ApartmentOption[30`+ (numberDoorWindowVariant + 1) + `].OptionDescription" oninput="sendToFinalStep(this)"></textarea>
    ...
    for (i = 2; i <= numberDoorWindowVariant; i++) {
        ...
        document.getElementsByName(thisDoorWindowName)[0].value = doorWindowNameArray[i];
        document.getElementsByName(thisDoorWindowPrice)[0].value = doorWindowPriceArray[i];
        document.getElementsByName(thisDoorWindowDescription)[0].value = doorWindowDescriptionArray[i];
