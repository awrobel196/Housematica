	    ...
	    <div id="variant" style="margin-top: 2em">
            ...
            <div class="col-xl-12">
                <div class="form-group">
                    ...
                    <span class="form-text text-muted">Wpisz nazwê kondygacji</span>
                </div>
            </div>
           ...
           <div class="col-xl-6">
                <div class="form-group">
					...
					<div class="custom-file">
						...
						<span class="form-text text-muted" >Wybierz plan piêtra w formacjie .pdf</span>
