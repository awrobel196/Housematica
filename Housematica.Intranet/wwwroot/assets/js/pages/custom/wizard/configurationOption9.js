...
function addKitchenVariant() {
	...
	<div class="col-xl-6" id="kitchenConfigure listElement">
...
function addBathroomVariant() {
	...
	<div class="col-xl-6" id="bathroomConfigure listElement">
...
function addRoomsVariant() {
	...
	<div class="col-xl-6" id="roomsConfigure listElement">
...
function addDoorWindowVariant() {
	...
	<div class="col-xl-6" id="doorWindowConfigure listElement">
