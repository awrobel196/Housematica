	    ...
	    <div id="variant" style="margin-top: 2em">
		    ...
		    <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" id="apartmentArea`+(numberOfVariant+1)+`" asp-for="ApartmentVariants[` + (numberOfVariant + 1) + `].ApartmentArea" placeholder="Apartment area" value="" oninput="sendToFinalStep(this)" />
            ...
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" id="balconyArea`+ (numberOfVariant + 1) +`" asp-for="ApartmentVariants[` + (numberOfVariant + 1) + `].BalconyArea" placeholder="Balcon/garden area" value="" oninput="sendToFinalStep(this)"/>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input min="0" type="number" class="form-control form-control-solid form-control-lg"  id="` + (numberOfVariant + 1) + ` " placeholder="Number rooms"  onwheel="return false;" onkeyup="addRooms(this.id)" onclick="addRooms(this.id)" oninput="sendToFinalStep(this)"/>
            ...
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    onwheel="return false;" class="form-control form-control-solid form-control-lg" id="numberLivingRoom`+ (numberOfVariant + 1) +`" asp-for="ApartmentVariants[` + (numberOfVariant + 1) + `].NumberOfLivingRoom" id="roomNumber" placeholder="Number living room" value="" oninput="sendToFinalStep(this)"/>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-solid form-control-lg" id="apartmentPrice`+ (numberOfVariant + 1) +`" asp-for="ApartmentVariants[` + (numberOfVariant + 1) + `].ApartmentPrice" id="roomNumber" placeholder="Apartment price" value="" oninput="sendToFinalStep(this)"/>
...
function addRooms(element) {
    var variableId = "placeToHtml1";
    console.log(variableId);
    var roomListvariableId = "finalRoomList" + element;
    var number = $("#" + element).val();

    var variableName = "placeToHtml" + element;
    document.getElementById(variableId).innerHTML = 'cxv';
    document.getElementById(roomListvariableId).innerHTML = 'xcv';
    for (var i = 0; i < number; i++) {
     ...
     <div class="form-group">
         ...
         <input type="text" class="form-control form-control-solid form-control-lg" id="`+ element + `roomName` + (i + 1) + `" asp-for="ApartmentVariants[`+ element + `].Rooms[` + (i + 1) + `].RoomName" placeholder="Room name" oninput="sendToFinalStep(this)" value="" />
 ...
 <div class="col-xl-6">
     ...
     <div class="form-group">
         ...
         <input type="text" class="form-control form-control-solid form-control-lg" id="`+ element + `roomArea` + (i + 1) + `" asp-for="ApartmentVariants[`+ element + `].Rooms[` + (i + 1) + `].RoomArea" placeholder="Room area" oninput="sendToFinalStep(this)" value="" />
